...
public class SeattleViewGwtImpl extends Composite implements SeattleView {

	/**
	 * The UiBinder interface.
	 */	
	interface SeattleViewGwtImplUiBinder extends
			UiBinder<Widget, SeattleViewGwtImpl> {
	}
	
	/**
	 * The UiBinder used to generate the view.
	 */
	private static SeattleViewGwtImplUiBinder uiBinder = GWT
			.create(SeattleViewGwtImplUiBinder.class);
    ...
    public void refreshMap() {
		context2 = flowCanvas.getContext2d();
		context2.clearRect(0, 0, 1121, 2585);
    }
