...
public class AppMainAnimationMapper implements AnimationMapper {
  ...
  public Animation getAnimation(Place oldPlace, Place newPlace) {
    ...
    if (oldPlace instanceof AboutPlace && newPlace instanceof SeattlePlace) {
        return Animations.FADE_REVERSE;
    }
    
    if (oldPlace instanceof SettingsPlace && newPlace instanceof SeattlePlace) {
        return Animations.FADE_REVERSE;
    }
    
    if (oldPlace instanceof CameraPlace && newPlace instanceof SeattlePlace) {
    	return Animations.FADE_REVERSE;
    }
    
    if (oldPlace instanceof AboutPlace && newPlace instanceof TacomaPlace) {
        return Animations.FADE_REVERSE;
    }
    
    if (oldPlace instanceof SettingsPlace && newPlace instanceof TacomaPlace) {
        return Animations.FADE_REVERSE;
    }
    
    if (oldPlace instanceof CameraPlace && newPlace instanceof TacomaPlace) {
    	return Animations.FADE_REVERSE;
    }
